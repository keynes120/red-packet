...
const downloadButton = (vm, h, currentRow, index) => { //文件下载
    return h('Button', {
        props: {
            type: currentRow.editting ? 'success' : 'primary',
            loading: currentRow.saving
...
const detailButton = (vm, h, currentRow, index) => { //文件下载
    return h('Button', {
        props: {
            type: currentRow.editting ? 'success' : 'primary',
            loading: currentRow.saving
...
const updateButton = (vm, h, currentRow, index) => { //文件下载
    return h('Button', {
        props: {
            type: currentRow.editting ? 'success' : 'primary',
            loading: currentRow.saving
                    ...
                    item.render = (h, param) => {
                        ...
                        item.handle.forEach(item => {
                            if (item === 'edit') {
                                ...
                                children.push(updateButton(this, h, currentRowData, param.index));
                            }
                        });
